...
Private Nostr relay for [Media Centaur](https://github.com/media-centaur/media-centaur)'s Social feature. One friend group, one instance. Only members read or write; admins add members at runtime; only Media Centaur's activities — reviews (kind 32164), watched titles (32161), listings (32163) — and their deletions (kind 5) are stored.
