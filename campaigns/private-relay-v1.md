...
* ✅ A tagged release with a container image on GHCR (`v0.1.0`; package visibility to be set public by the owner). ✅ Wiki page *Hosting a Private Relay* published.
